...
@interface KBActivityItemQQView ()
{
...
@implementation KBActivityItemQQView
...
#if __has_include(<UMSocial.h>)
    [UMSocialDataService defaultDataService].socialData.extConfig.qqData.url = _shareURL.absoluteString;
    [UMSocialDataService defaultDataService].socialData.extConfig.qqData.title = _shareTitle;
